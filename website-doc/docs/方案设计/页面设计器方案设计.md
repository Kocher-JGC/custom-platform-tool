...
![图片描述](../assets/应用-页面设计器-业务领域模型.png)
...
![图片描述](../assets/应用-页面设计器-页面设计器.png)
...
![图片描述](../assets/应用-页面设计器-分层架构.png)

![图片描述](../assets/应用-页面设计器-分层架构-详细.png)

### 7.1. 模块 UML

![图片描述](../assets/应用-页面设计器-可视化编辑器数据UML.png)
...
![图片描述](../assets/应用-页面设计器-页面数据-IUB-DSL.png)
