...
export class ColumnsSpeedyHelper extends React.Component<Props> {
  ...
  constructDsList = () => {
    ...
    const { fieldsFromDs, fieldListNotFromDs } = this.constructFields(
      fieldList
    );
  ...
  handleChangeQueryType = ({ attr, value, id }) => {
    ...
    const prevQueryList: string[] =
      this.state?.[queryTypeListAttr].slice() || [];
      ...
      <>
        <div className="tool-bar my-1">
          ...
          <Button
            ...
            className="mr-2"
            size="small"
            onClick={this.handleHideSysColumn}
          >
