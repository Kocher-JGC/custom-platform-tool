...
echo -e "\033[34m docker starting cmd: docker run -d --name $app_alias -p $app_port:$app_source_port -v $app_config_path:$app_target_env_config_path $app_name:$release_tag \033[0m"
